...
; Source: ../../language/examples/erro.sp


section .data
    str_0 db 74, 97, 114, 98, 101, 115, 32, 100, 101, 116, 101, 99, 116, 97, 32, 101, 114, 114, 111, 115, 32, 101, 109, 32, 99, 111, 109, 112, 105, 108, 97, 195, 167, 195, 163, 111, 33, 10
    str_0_len equ $ - str_0
